...
export default class Cac extends EventEmitter {
  ...
  showHelp() {
    ...
    console.log("🚀 ~ Cac ~ showHelp ~ this.firstArg:", this.firstArg)
    console.log("🚀 ~ Cac ~ showHelp ~ this.matchedCommand:", this.matchedCommand)
    const displayCommands = !isExplictCommand(this.firstArg);
    console.log("🚀 ~ Cac ~ showHelp ~ displayCommands:", displayCommands)
    // console.log("🚀 ~ Cac ~ showHelp ~ this:", this)
